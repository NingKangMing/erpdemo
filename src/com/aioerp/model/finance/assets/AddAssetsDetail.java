...
public class AddAssetsDetail
  extends BaseDbModel
{
  public static final AddAssetsDetail dao = new AddAssetsDetail();
  public static final String TABLE_NAME = "cw_addassets_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_addassets_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_addassets_detail where 1=1");
