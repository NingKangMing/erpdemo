...
public class AddAssetsBill
  extends BaseDbModel
{
  public static final AddAssetsBill dao = new AddAssetsBill();
  public static final String TABLE_NAME = "cw_addassets_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_addassets_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
