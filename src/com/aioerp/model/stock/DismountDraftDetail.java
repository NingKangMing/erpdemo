...
public class DismountDraftDetail
  extends BaseDbModel
{
  public static final DismountDraftDetail dao = new DismountDraftDetail();
  public static final String TABLE_NAME = "cc_dismount_draft_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId, Integer type)
  {
    ...
    helper.appendSql(" from cc_dismount_draft_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cc_dismount_draft_detail where 1=1");
