...
public class SubAssetsBill
  extends BaseDbModel
{
  public static final SubAssetsBill dao = new SubAssetsBill();
  public static final String TABLE_NAME = "cw_subassets_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_subassets_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
