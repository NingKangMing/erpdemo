...
public class OtherOutBill
  extends BaseDbModel
{
  public static final OtherOutBill dao = new OtherOutBill();
  public static final String TABLE_NAME = "cc_otherout_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cc_otherout_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
