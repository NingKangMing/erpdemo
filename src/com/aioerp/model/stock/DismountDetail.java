...
public class DismountDetail
  extends BaseDbModel
{
  public static final DismountDetail dao = new DismountDetail();
  public static final String TABLE_NAME = "cc_dismount_detail";
  ...
  public BigDecimal getOtherAmount(String configName, Integer unitId)
  {
    Product product = (Product)get("product");
  ...
  public List<Model> getListByBillId(String configName, Integer billId, Integer type)
  {
    ...
    helper.appendSql(" from cc_dismount_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("select * from cc_dismount_detail where 1=1");
    if (billId != null) {
