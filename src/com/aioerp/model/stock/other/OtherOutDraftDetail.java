...
public class OtherOutDraftDetail
  extends BaseDbModel
{
  public static final OtherOutDraftDetail dao = new OtherOutDraftDetail();
  public static final String TABLE_NAME = "cc_otherout_draft_detail";
  ...
  {
    FlowDetail.setComStorage(detail, fDetail, null, "storageId");
