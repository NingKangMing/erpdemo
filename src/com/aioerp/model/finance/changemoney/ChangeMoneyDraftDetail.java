...
public class ChangeMoneyDraftDetail
  extends BaseDbModel
{
  public static final ChangeMoneyDraftDetail dao = new ChangeMoneyDraftDetail();
  public static final String TABLE_NAME = "cw_c_money_draft_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_c_money_draft_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_c_money_draft_detail where 1=1");
