...
public class ParityAllotBill
  extends BaseDbModel
{
  public static final ParityAllotBill dao = new ParityAllotBill();
  public static final String TABLE_NAME = "cc_parityallot_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cc_parityallot_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
