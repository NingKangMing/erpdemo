...
public class OverflowDetail
  extends BaseDbModel
{
  public static final OverflowDetail dao = new OverflowDetail();
  public static final String TABLE_NAME = "cc_overflow_detail";
  ...
  public List<Model> getList(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cc_overflow_detail as detail");
  ...
  {
    String sql = "SELECT id FROM cc_overflow_detail WHERE billId = ?";
  ...
  {
    String sql = "SELECT * FROM cc_overflow_detail WHERE billId = ? ";
