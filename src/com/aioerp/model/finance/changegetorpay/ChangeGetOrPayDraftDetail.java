...
public class ChangeGetOrPayDraftDetail
  extends BaseDbModel
{
  public static final ChangeGetOrPayDraftDetail dao = new ChangeGetOrPayDraftDetail();
  public static final String TABLE_NAME = "cw_c_unitgetorpay_draft_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_c_unitgetorpay_draft_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_c_unitgetorpay_draft_detail where 1=1");
