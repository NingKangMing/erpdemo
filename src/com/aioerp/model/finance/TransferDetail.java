...
public class TransferDetail
  extends BaseDbModel
{
  public static final TransferDetail dao = new TransferDetail();
  public static final String TABLE_NAME = "cw_transfer_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_transfer_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_transfer_detail where 1=1");
