...
public class SubAssetsDraftDetail
  extends BaseDbModel
{
  public static final SubAssetsDraftDetail dao = new SubAssetsDraftDetail();
  public static final String TABLE_NAME = "cw_subassets_draft_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_subassets_draft_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_subassets_draft_detail where 1=1");
  ...
  {
    String sql = "delete from cw_subassets_draft_detail where billId = ? ";
