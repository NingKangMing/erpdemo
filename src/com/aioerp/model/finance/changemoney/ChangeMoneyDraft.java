...
public class ChangeMoneyDraft
  extends BaseDbModel
{
  public static final ChangeMoneyDraft dao = new ChangeMoneyDraft();
  public static final String TABLE_NAME = "cw_c_money_draft_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_c_money_draft_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
