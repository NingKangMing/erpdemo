...
public class DismountBill
  extends BaseDbModel
{
  public static final DismountBill dao = new DismountBill();
  public static final String TABLE_NAME = "cc_dismount_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cc_dismount_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
