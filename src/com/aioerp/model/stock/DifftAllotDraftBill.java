...
public class DifftAllotDraftBill
  extends BaseDbModel
{
  public static final DifftAllotDraftBill dao = new DifftAllotDraftBill();
  public static final String TABLE_NAME = "cc_difftallot_draft_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cc_difftallot_draft_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
