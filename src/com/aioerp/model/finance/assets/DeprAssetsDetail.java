...
public class DeprAssetsDetail
  extends BaseDbModel
{
  public static final DeprAssetsDetail dao = new DeprAssetsDetail();
  public static final String TABLE_NAME = "cw_deprassets_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_deprassets_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_deprassets_detail where 1=1");
