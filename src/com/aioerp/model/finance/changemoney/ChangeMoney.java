...
public class ChangeMoney
  extends BaseDbModel
{
  public static final ChangeMoney dao = new ChangeMoney();
  public static final String TABLE_NAME = "cw_c_money_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_c_money_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
