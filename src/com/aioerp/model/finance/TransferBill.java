...
public class TransferBill
  extends BaseDbModel
{
  public static final TransferBill dao = new TransferBill();
  public static final String TABLE_NAME = "cw_transfer_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_transfer_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
