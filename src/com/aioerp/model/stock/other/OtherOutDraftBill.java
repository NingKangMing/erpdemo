...
public class OtherOutDraftBill
  extends BaseDbModel
{
  public static final OtherOutDraftBill dao = new OtherOutDraftBill();
  public static final String TABLE_NAME = "cc_otherout_draft_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cc_otherout_draft_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
  ...
  {
    FlowBill.setComStorage(record, fBill, null, "storageId");
    ...
    record.set("accountsId", Integer.valueOf(39));
    return record;
  }
}
