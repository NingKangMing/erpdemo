...
public class SubAssetsDetail
  extends BaseDbModel
{
  public static final SubAssetsDetail dao = new SubAssetsDetail();
  public static final String TABLE_NAME = "cw_subassets_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_subassets_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_subassets_detail where 1=1");
