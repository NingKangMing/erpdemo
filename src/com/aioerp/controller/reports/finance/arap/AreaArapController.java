...
public class AreaArapController
  extends BaseController
{
  private static String listID = "areaArapList";
    ...
    throws SQLException, Exception
  {
    ...
    Map<String, Object> pageMap = Area.dao.getAreaArapPage(loginConfigName(), basePrivs(AREA_PRIVS), listID, pageNum, numPerPage, orderField, orderDirection, supId, null, startTime, endTime, node.intValue());
    ...
    throws SQLException, Exception
  {
    ...
    Map<String, Object> pageMap = Area.dao.getAreaArapPage(configName, basePrivs(AREA_PRIVS), listID, pageNum.intValue(), numPerPage.intValue(), orderField, orderDirection, supId, Integer.valueOf(upObjectId), startTime, endTime, node.intValue());
    
    Integer pSupId = Integer.valueOf(0);
    if (supId > 0) {
      pSupId = Integer.valueOf(Area.dao.getPsupId(configName, supId));
    }
    columnConfig("cw523");
  ...
  public void tree()
  {
    ...
    List<Model> sorts = Area.dao.getAllSorts(loginConfigName(), areaPrivs);
    ...
    while (iter.hasNext())
    {
      ...
      node.put("url", "reports/finance/arap/areaArap/list/" + mode.get("id"));
      nodeList.add(node);
    }
    HashMap<String, Object> node = new HashMap();
    ...
    node.put("name", "地区信息");
    node.put("url", "reports/finance/arap/areaArap/list/0");
    nodeList.add(node);
  ...
  public void unitDetail()
    throws SQLException, Exception
  {
    String pageId = "areaUnitArapPage";
    String alias = "bu";
    String configName = loginConfigName();
    Integer selectedObjectId = getParaToInt("selectedObjectId", Integer.valueOf(0));
    String areaName = "其他地区";
    String pids = null;
    if (selectedObjectId.intValue() > 0)
    {
      Area area = (Area)Area.dao.findById(configName, selectedObjectId);
      areaName = area.getStr("fullName");
      pids = area.getStr("pids");
    }
    String startTime = getPara("startTime");
    String endTime = getPara("endTime");
    ...
    Map<String, Object> pageMap = Area.dao.getUnitArapPageByDept(configName, basePrivs(UNIT_PRIVS), pageId, pageNum, numPerPage, orderField, orderDirection, startTime, endTime, pids, alias);
  ...
  public void staffDetail()
    throws SQLException, Exception
  {
    String pageId = "areaStaffArapPage";
    String alias = "bs";
    String configName = loginConfigName();
    Integer selectedObjectId = getParaToInt("selectedObjectId", Integer.valueOf(0));
    String areaName = "其他地区";
    ...
    Map<String, Object> pageMap = Area.dao.getUnitArapPageByDept(configName, basePrivs(STAFF_PRIVS), pageId, pageNum, numPerPage, orderField, orderDirection, startTime, endTime, pids, alias);
    ...
    throws SQLException, Exception
  {
    ...
    {
      String alias = "bu";
      pageMap = Area.dao.getUnitArapPageByDept(configName, basePrivs(UNIT_PRIVS), "", pageNum, numPerPage, orderField, orderDirection, startTime, endTime, pids, alias);
    }
    else if (m == 2)
    {
      String alias = "bs";
      pageMap = Area.dao.getUnitArapPageByDept(configName, basePrivs(STAFF_PRIVS), "", pageNum, numPerPage, orderField, orderDirection, startTime, endTime, pids, alias);
    }
