...
public class OtherEarnDraftDetail
  extends BaseDbModel
{
  public static final OtherEarnDraftDetail dao = new OtherEarnDraftDetail();
  public static final String TABLE_NAME = "cw_otherearn_draft_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_otherearn_draft_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_otherearn_draft_detail where 1=1");
