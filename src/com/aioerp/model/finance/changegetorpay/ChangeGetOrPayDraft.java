...
public class ChangeGetOrPayDraft
  extends BaseDbModel
{
  public static final ChangeGetOrPayDraft dao = new ChangeGetOrPayDraft();
  public static final String TABLE_NAME = "cw_c_unitgetorpay_draft_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_c_unitgetorpay_draft_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
