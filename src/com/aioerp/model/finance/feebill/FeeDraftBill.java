package com.aioerp.model.finance.feebill;
...
public class FeeDraftBill
  extends BaseDbModel
{
  public static final FeeDraftBill dao = new FeeDraftBill();
  public static final String TABLE_NAME = "cw_fee_draft_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_fee_draft_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
