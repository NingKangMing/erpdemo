...
public class DeprAssetsDraftBill
  extends BaseDbModel
{
  public static final DeprAssetsDraftBill dao = new DeprAssetsDraftBill();
  public static final String TABLE_NAME = "cw_deprassets_draft_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_deprassets_draft_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
