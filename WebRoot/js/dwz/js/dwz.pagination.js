	...
	$.fn.extend({
		pagination: function(opts){
			...
			return this.each(function(){
				...
				var noInput = $this.attr("noInput");
				if(noInput&&noInput=="true"){
					$this.html(DWZ.frag["pagination1"].replaceAll("#pageNumFrag#", pageNumFrag).replaceAll("#currentPage#", pc.getCurrentPage())).find("li").hoverClass();
				}else{
