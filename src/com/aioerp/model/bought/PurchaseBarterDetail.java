...
public class PurchaseBarterDetail
  extends BaseDbModel
{
  public static final PurchaseBarterDetail dao = new PurchaseBarterDetail();
  public static final String TABLE_NAME = "cg_barter_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId, Integer type)
  {
    ...
    helper.appendSql(" from cg_barter_detail as detail");
