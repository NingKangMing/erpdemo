...
public class AddAssetsDraftBill
  extends BaseDbModel
{
  public static final AddAssetsDraftBill dao = new AddAssetsDraftBill();
  public static final String TABLE_NAME = "cw_addassets_draft_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_addassets_draft_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
