...
public class OverflowDraftDetail
  extends BaseDbModel
{
  public static final OverflowDraftDetail dao = new OverflowDraftDetail();
  public static final String TABLE_NAME = "cc_overflow_draft_detail";
  ...
  public List<Model> getList(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cc_overflow_draft_detail as detail");
  ...
  {
    String sql = "SELECT id FROM cc_overflow_draft_detail WHERE billId = ?";
  ...
  {
    String sql = "SELECT * FROM cc_overflow_draft_detail WHERE billId = ? ";
    return dao.find(configName, sql, new Object[] { billId });
  }
  
  public Integer delDeail(String configName, Integer billId)
  {
    String sql = "delete from cc_overflow_draft_detail where billId = ? ";
