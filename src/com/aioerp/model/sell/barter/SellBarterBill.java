...
public class SellBarterBill
  extends BaseDbModel
{
  public static final SellBarterBill dao = new SellBarterBill();
  public static final String TABLE_NAME = "xs_barter_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from xs_barter_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
