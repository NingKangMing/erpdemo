...
public class FeeDraftDetail
  extends BaseDbModel
{
  public static final FeeDraftDetail dao = new FeeDraftDetail();
  public static final String TABLE_NAME = "cw_fee_draft_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_fee_draft_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_fee_draft_detail where 1=1");
