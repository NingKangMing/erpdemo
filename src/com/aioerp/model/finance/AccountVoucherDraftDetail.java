...
public class AccountVoucherDraftDetail
  extends BaseDbModel
{
  public static final AccountVoucherDraftDetail dao = new AccountVoucherDraftDetail();
  public static final String TABLE_NAME = "cw_accountvoucher_draft_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cw_accountvoucher_draft_detail as detail");
  ...
  {
    StringBuffer sql = new StringBuffer("delete from cw_accountvoucher_draft_detail where 1=1");
