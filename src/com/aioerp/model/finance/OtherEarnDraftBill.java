...
public class OtherEarnDraftBill
  extends BaseDbModel
{
  public static final OtherEarnDraftBill dao = new OtherEarnDraftBill();
  public static final String TABLE_NAME = "cw_otherearn_draft_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_otherearn_draft_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
