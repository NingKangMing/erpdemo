...
public class DifftAllotDetail
  extends BaseDbModel
{
  public static final DifftAllotDetail dao = new DifftAllotDetail();
  public static final String TABLE_NAME = "cc_difftallot_detail";
  ...
  public List<Model> getListByBillId(String configName, Integer billId)
  {
    ...
    helper.appendSql(" from cc_difftallot_detail as detail");
  ...
  {
    String sql = "SELECT * FROM cc_difftallot_detail WHERE billId = " + billId;
