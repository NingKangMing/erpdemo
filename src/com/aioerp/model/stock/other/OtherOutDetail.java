...
public class OtherOutDetail
  extends BaseDbModel
{
  public static final OtherOutDetail dao = new OtherOutDetail();
  public static final String TABLE_NAME = "cc_otherout_detail";
  ...
  {
    StringBuffer sql = new StringBuffer("select * from cc_otherout_detail where 1=1");
