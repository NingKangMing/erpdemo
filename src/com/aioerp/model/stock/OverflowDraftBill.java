...
public class OverflowDraftBill
  extends BaseDbModel
{
  public static final OverflowDraftBill dao = new OverflowDraftBill();
  public static final String TABLE_NAME = "cc_overflow_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cc_overflow_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
