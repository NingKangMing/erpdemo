...
public class FeeBill
  extends BaseDbModel
{
  public static final FeeBill dao = new FeeBill();
  public static final String TABLE_NAME = "cw_fee_bill";
  ...
  {
    return Db.use(configName).queryLong("select count(*) from cw_fee_bill where code =? and id != ?", new Object[] { code, Integer.valueOf(id) }).longValue() > 0L;
  }
}
